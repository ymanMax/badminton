...
Page({
  ...
  cancelOrder(e) {
    ...
    app.confirm({ content: '确认取消预约？' }, (res) => {
      if (res.cancel) return;
      app.request('post', 'applet/badminton/place/cancelReservePlaceApply', {
        id: arg.id
      }, (res) => {
        if (res.code == '0000') {
          this.getOrderList();
  ...
  getOrderList() {
    app.request('post', 'applet/badminton/reservePlaceApply/getPageList', {
      query: {},
      page: {
        size: 999,
        current: 1,
